package com.brandstreet.foreignexchange.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.brandstreet.foreignexchange.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.brandstreet.foreignexchange.repository.UserRepository.USERS_BY_EMAIL_CACHE);
